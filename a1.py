...
def get_hours(second_hour):
    ...
    2
    '''
    return second_hour // 3600





def get_minutes(second_minut):
    '''(int) -> int
    ...
    3
    '''
    return (second_minut % 3600) // 60





def get_seconds(second_midnight):
    '''(int) -> int

    Return the number of get_seconds that have elapsed since midnight as seen on a clock.
    ...
    12
    '''
    return (second_midnight % 3600) % 60
